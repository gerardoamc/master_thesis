...
This work will apply the OOC to FFF, in the hopes that it becomes a tool for safely designing parts intended to be manufactured through this process. The upcoming chapters will detail the material and experimental methods followed to achieve this goal.  
