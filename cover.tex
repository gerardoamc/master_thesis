...
\begin{titlepage}
	\begin{center}
		\vspace{1cm}
		{\scshape\Huge\textbf{Robotic Off-Axis Fused Filament Fabrication} \par}
		\vspace{1cm}
		...
		{\Large 2018 \par}
		\vfill
		{\large Final Oral Examination: August 11th, 2018}		%MODIFY DATE
	\end{center}
\end{titlepage}
...
\chapter*{Approval}
%\thispagestyle{fancy}
The following thesis, \textbf{Robotic Off-Axis Fused Filament Fabrication}, developed at the \textbf{University of Wisconsin-Madison}
