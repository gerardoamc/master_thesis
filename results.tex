...
Figure \ref{fig:1122plane} indicates that FFF parts produced with the print parameters used in this body of work should show considerable strengthening when loaded bi-axially in compression. Further experimental work would be of interest to compare bi-axial data to this result.
