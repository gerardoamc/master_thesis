...
\begin{figure}[h]
	\center
	\includegraphics[height=6cm]{TAZ_5}
	\caption{TAZ 5 printer \cite{Lulzbot2018}} \label{fig:taz5}
\end{figure}

\begin{figure}[h]
	\center
	\includegraphics[height=7cm]{Otto}
	\caption{6-axis robotic printer: \emph{Otto}} \label{fig:Otto}
\end{figure}
